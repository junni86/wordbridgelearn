...
#endif
{
    ...
    private XNamespace toolsNs = "http://schemas.android.com/tools";
...
#endif
    {
        ...
        // tools 네임스페이스 선언 추가 (manifest merger 충돌 방지용)
        if (elemManifest.Attribute(XNamespace.Xmlns + "tools") == null)
        {
            elemManifest.Add(new XAttribute(XNamespace.Xmlns + "tools",
    ...
    private XElement CreateMetaElement(string name, object value)
    {
        return new XElement("meta-data",
                ...
                new XAttribute(toolsNs + "replace", "android:value"));
    }
                                    ...
                                    string metadataValue)
    {
        ...
        else
        {
            ...
            element.SetAttributeValue(toolsNs + "replace", "android:value");
        }
    }
